...
#define L(sev) LOG::AutoTerminator(LOG::Core::getInstance().startRecord(__FILE__,__LINE__,__FUNCTION__,NAME,sev))
#define L_SENDER(sev,sender) LOG::AutoTerminator(LOG::Core::getInstance().startRecord(__FILE__,__LINE__,__FUNCTION__,sender,sev))
//#define LL(sev) LOG::AutoTerminator(LOG::Core::getInstance().startRecord(__FILE__,__LINE__,__FUNCTION__,NAME,sev))
